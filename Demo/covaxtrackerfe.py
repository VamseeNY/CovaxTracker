...
with header:
    ...
    with txt:
        ...
        st.subheader("Notifications inform users on:")
        st.text("Address of Vaccination center")
        st.text("Center ID")
        st.text("Age group(18+ or 45+)")
        st.text("Fee Type(Free or Paid)")
        ...
        st.subheader("Code")
        st.text("The source code for the bot,channel automation and this webpage are available at: ")
        st.write("[https://github.com/VamseeNY/CovaxTracker](https://github.com/VamseeNY/CovaxTracker)")
        st.subheader("Note")
        st.text("This bot has been deactivated since early 2022.")
    with mp:
